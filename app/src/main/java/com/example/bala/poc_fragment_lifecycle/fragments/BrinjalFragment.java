...
public class BrinjalFragment extends Fragment {

    private String TAG = BrinjalFragment.class.getSimpleName();
    ...
    public static BrinjalFragment newInstance(int columnCount) {
        BrinjalFragment fragment = new BrinjalFragment();
    ...
    private void transactionProcess() {
        try {
            ...
            mBundle.putString(SELECTED_VALUE, "Hello Orange");
            BrinjalFragment mBrinjalFragment = (BrinjalFragment) mFragmentManager.findFragmentByTag(BRINJAL_FRAGMENT);
            if (mBrinjalFragment == null) {
                mBrinjalFragment = BrinjalFragment.newInstance(1);
            }
            mBrinjalFragment.setArguments(mBundle);
            if (DUAL_PANE) {
                mFragmentTransaction.replace(R.id.detailscontainer, mBrinjalFragment);
            } else {
                mFragmentTransaction.replace(R.id.listcontainer, mBrinjalFragment, BRINJAL_FRAGMENT);
            }
